...
const dbConfig = {
  connectionLimit: process.env.GCHECK_DB_CONNECTION_LIMIT,
  ...
  database: process.env.GCHECK_DB_NAME,
  debug: process.env.GCHECK_DB_DEBUG === 'true' ? ['ComQueryPacket', 'RowDataPacket'] : false,
